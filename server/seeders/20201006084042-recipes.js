  ...
  up: async (queryInterface, Sequelize) => {
    await models.Recipe.bulkCreate([
      ...
      },
      {
        ...
        url: 'https://www.marmiton.org/recettes/recette_pates-a-la-carbonara_80453.aspx#d81306-p2',
        guests: 4,
      ...
      },
      {
        ...
        url: 'https://www.ptitchef.com/recettes/plat/boudin-blanc-gratine-au-maroilles-fid-1227497',
        guests: 4,
