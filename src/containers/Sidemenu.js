  ...
  return (
    <div className={isSideMenuActive ? 'sidemenu active' : 'sidemenu inactive'}>
      ...
      <nav className="sidemenu--navlist">
        ...
        <NavLink activeClassName="active-link" onClick={() => toggleFunction(setMenu)} to="/recipes">
          <li>
            <img className="sidemenu--icon icon" src={recipesIcon} alt="recipes" />
            <h2>Mes recettes</h2>
          </li>
        </NavLink>
        <NavLink activeClassName="active-link" onClick={() => toggleFunction(setMenu)} to="/inventory">
          <li>
            <img className="sidemenu--icon icon" src={inventoryIcon} alt="inventory" />
            <h2>Inventaire</h2>
          </li>
        </NavLink>
        <NavLink activeClassName="active-link" onClick={() => toggleFunction(setMenu)} to="/shoplist">
          <li>
