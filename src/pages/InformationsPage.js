    ...
    <>
      <div className="informations page">
        ...
        <Section>
          ...
          <p>
            En tant que jeune développeur toujours prêt à apprendre et m'améliorer, tous les avis,
            retours ou suggestions concernant l'appli sont les bienvenus !
          </p>
          <hr />
          ...
          <ul>
            ...
            <li>
              <p>Back-end : Node.js / Express / Sequelize</p>
            </li>
          </ul>
          <hr />
          <p>
